...
\begin{exampleblock}{Common reasons for writing tests}
  \begin{itemize} 
    \item Catch bugs introduced during development
    \item Maintain backwards compatibility
    \item Verify output of newly implemented function
    \item Introduction to new developers 
    \item Provide a scaffold for code design
  \end{itemize}
\end{exampleblock}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{How does it work?}
    ...
    \begin{itemize}
      ...
      \item Then, you write a minimal amount of code to make the test pass
      \item Finally, verify that all tests succeed.
      \item Connect all the units and you will have the complete program.
...
\begin{frame}
  ...
  \begin{block}{What are the advantages?}
    \begin{itemize}
      ...
      \item Tests don't cost extra time to write
      \item \textbf{Y}ou \textbf{A}ren't \textbf{G}onna \textbf{N}eed \textbf{I}t.
      \begin{itemize}
        \item No code written besides the essentials
	\item Code stays simple and modular
      \end{itemize}
...
\begin{frame}
  ...
  \begin{block}{What are the key ideas?}
    \begin{itemize}
      \item The intended behavior of a program determines the development strategy
      \item Using domain specific language to describe behavior
      \begin{itemize}
        \item Often close to natural language, with some object-oriented elements
      \end{itemize}

      \item Allow non-experts to design software and tests
      \item Have programmers implement them
    \end{itemize}
...
\begin{frame}
  ...
  \begin{block}{Attempt to at least:}
    \begin{itemize}
      \item  Focus on small units of functionality and ensure correctness
      \item  Tests must be able to run independently (see Mock for help)
      \item  Keep them fast! Slowness discourages running tests.
      \item  Write a test for debugging.
      \item  Keep your code clear, keep your tests clearer!
    \end{itemize}
    \vfill
